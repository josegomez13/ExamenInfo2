...
\subsection{Intento número 3 hay que moverlo a la section integrados}\label{intento3 mover}
...
\subsection{Intento número 3(prueba conexión entre arduinos falla)}\label{intento3}
